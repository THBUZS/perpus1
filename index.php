...
<link rel="stylesheet" href="style.css">
  ...
  <ul>
  <li><a class="active" href="readBooks.php">Buku</a></li>
  <li><a href="readMembers.php">Member </a></li>
  <li><a href="readBorrow.php">Pinjaman Buku</a></li>
</ul>
    ...
    <section class="py-5 text-center container">
        <div class="row py-lg-5">
            <div class="col-lg-6 col-md-8 mx-auto">
              <div class="Intro">
                <h1 class="intro">My Perpustakaan</h1>
                <p class="lead-text-muted">Website ini bisa mempermudah proses pinjam meminjam buku online</p>
